    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-primary" ><a style="color:white" href="{{ route('service-draft.edit') }}">+ Service</a></button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('service-draft.edit',$service->id)}}"><i class="fa fa-edit"></i></a>
